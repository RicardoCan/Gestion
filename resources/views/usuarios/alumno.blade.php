...
<center><h3 style="color: white">Bienvenid@: {{Session::get('usuario')}}</h3></center>
     ...
     <div class="row ">
        <div class="col clearfix">
          ...
          <div class="table-responsive">
            ...
            <tbody>
              <tr v-for="(alumno,index) in filtroAlumnos" style="color: white">
...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="col-5">
        ...
        <center><input type="text" placeholder="Escriba Nombres" v-model="id_nombres" class="form-control">
        <br> 
        ...
        <div class="container">
          <div class="row">
           <div class="col clearfix">
              ...
              <button class="btn btn-primary" v-on:click="actualizarAlumnos(id_nombres)">Guardar</button>
              ...
              <button class="btn btn-secondary"><a href="califusu" style="color: white">Siguiente</a></button>
