  ...
  <div class="container">
     <div class="row">
        ...
        <div class="table-responsive">
            ...
            <tbody>
              <tr v-for="(compromiso,index) in filtroCompromiso" style="color: white" class="table-active">
          ...
          <div class="row">
           <div class="col clearfix">
             ...
             <center> <button class="btn btn-primary" v-on:click="actualizarCompromiso(id_nombre)">Guardar</button>
              ...
              <button class="btn btn-info"><a href="clas" style="color: white">Anterior</a></button></center>
