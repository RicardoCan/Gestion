     ...
     <div class="row">
        <div class="col clearfix">
          ...
          <div class="table-responsive">
            ...
            <tbody>
              <tr v-for="(calificacion,index) in filtroCalificaciones" style="color: white" class="table-active">
        ...
        <div class="container">
          <div class="row">
           <div class="col clearfix">
              ...
              <button class="btn btn-info"><a href="clas" style="color: white">Siguiente</a></button></center>
              ...
              <div class="container">
                <div class="row">
                  <div class="col clearfix">
                     ...
                     <center><button class="btn btn-secondary"><a href="asig" style="color: white">Anterior</a></button></center>
